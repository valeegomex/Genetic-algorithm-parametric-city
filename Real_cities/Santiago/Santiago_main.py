...
if __name__ ==  '__main__':
    ...
    AG = Algoritmo_genetico(n_zonas=n_zonas, poblacion=poblacion, gen_max=gen_max,
                             evaluador=evaluador, iterador=iterador, divisor=divisor, id='101', n_procesos=10,
                            name='SantiagoPoblacionInicial3')
    ...
    # Ejecutar algoritmo
    AG = Algoritmo_genetico(n_zonas=n_zonas, poblacion=poblacion, gen_max=gen_max,
                            evaluador=evaluador, iterador=iterador, divisor=divisor, id='104', n_procesos=10,
                            name='SantiagoPoblacionInicial3')
    ...
    # Ejecutar algoritmo
    AG = Algoritmo_genetico(n_zonas=n_zonas, poblacion=poblacion, gen_max=gen_max,
                            evaluador=evaluador, iterador=iterador, divisor=divisor, id='105', n_procesos=10,
                            name='SantiagoPoblacionInicial3')
