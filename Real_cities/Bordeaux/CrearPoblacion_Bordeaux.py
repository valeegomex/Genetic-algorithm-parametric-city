...
tmode=  TransportMode(name='bus', bya=0, co=8.61 , c1=0.15, c2=0, v=20, t=2.5, fmax=1000, kmax=160, theta=0.5, tat=0, d=1, fini=200)
...
poblacion.save_edl_population('BordeauxPoblacionInicial4')
